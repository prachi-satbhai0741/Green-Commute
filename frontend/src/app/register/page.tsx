...
export default function Register() {
  ...
  return (
    <div className="form-container animate-fade-in">
      <div className="card">
        <h1 className="form-title">Join GreenCommute</h1>
        <p className="form-subtitle">Create an account to start tracking</p>
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', color: 'var(--text-muted)' }}>
          Already have an account? <Link href="/signin" style={{ color: 'var(--primary)', fontWeight: '500' }}>Sign in</Link>
        </div>
      </div>
    </div>
  );
